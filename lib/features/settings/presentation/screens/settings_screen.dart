                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            const _ProFeatureRow(title: 'Unlimited Kosa Kata AAC & Bebas Tambah Foto Kamera Asli'),
                            const SizedBox(height: 8),
                            _ProFeatureRow(title: 'Rekam Suara ${UserProfileService.fatherCall} & ${UserProfileService.motherCall} Sepuasnya untuk Semua Kartu'),
                            const SizedBox(height: 8),
                            const _ProFeatureRow(title: 'Choice Board 4 Pilihan & Jadwal Rutinitas Mingguan'),
                            const SizedBox(height: 8),
                            const _ProFeatureRow(title: 'Sinkronisasi Multi-Device Cloudflare & Supabase'),
                            const SizedBox(height: 8),
                            const _ProFeatureRow(title: 'Jurnal Telemetri Lengkap Siap Dibagikan ke Terapis'),
                          ],
                        ),
