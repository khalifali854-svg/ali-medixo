  ...
  static const SurahDetail detail = SurahDetail(
    ...
    ayahs: [
      ...
      Ayah(
        ...
        shortTafsir: "Segala puji kita persembahkan hanya untuk Allah semata, Tuhan Pencipta dan Pemelihara seluruh alam, yaitu semua jenis makhluk.",
        sajda: false,
        audioUrl: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/2",
      ),
      Ayah(
        numberInSurah: 3,
        numberInQuran: 3,
        ...
        shortTafsir: "Dialah Yang Maha Pengasih, Pemilik dan sumber sifat kasih, Yang menganugerahkan segala macam karunia, baik besar maupun kecil, kepada seluruh makhluk, Maha Penyayang Yang selalu tiada henti memberi kasih dan kebaikan kepada orang-orang yang beriman.",
        sajda: false,
        audioUrl: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/3",
      ),
      Ayah(
        numberInSurah: 4,
        numberInQuran: 4,
        ...
        shortTafsir: "Dialah satu-satunya Pemilik hari Pembalasan dan perhitungan atas segala perbuatan, yaitu hari kiamat. Kepemilikan-Nya pada hari itu bersifat mutlak dan tidak disekutui oleh suatu apa pun.",
        sajda: false,
        audioUrl: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/4",
      ),
      Ayah(
        numberInSurah: 5,
        numberInQuran: 5,
        ...
        shortTafsir: "Atas dasar itu semua, hanya kepada Engkaulah kami menyembah dan beribadah dengan penuh ketulusan, kekhusyukan, dan tawakal, dan hanya kepada Engkaulah kami memohon pertolongan dalam segala urusan dan keadaan kami, sambil kami berusaha keras.",
        sajda: false,
        audioUrl: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/5",
      ),
      Ayah(
        numberInSurah: 6,
        numberInQuran: 6,
        ...
        shortTafsir: "Kami memohon, tunjukilah kami jalan yang lurus, dan teguhkanlah kami di jalan itu, yaitu jalan hidup yang benar, yang dapat membuat kami bahagia di dunia dan di akhirat, serta dapat mengantarkan kami menuju keridaan-Mu.",
        sajda: false,
        audioUrl: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6",
      ),
      Ayah(
        numberInSurah: 7,
        numberInQuran: 7,
